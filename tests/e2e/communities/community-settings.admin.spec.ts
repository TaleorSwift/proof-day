...
// E2E — /communities/[slug]/settings: acceso de usuario admin
// Auth setup: tests/e2e/auth.setup.ts (storageState admin configurado en playwright.config.ts)
// e2e-admin es admin de startup-madrid → puede ver y usar la sección de configuración
