...
- Agent manifest path: `{project-root}/_bmad/_config/agent-manifest.csv` (fallback: `{project-root}/_bmad/bmm/teams/default-party.csv`)

### Paths

- `installed_path` = `{project-root}/_bmad/core/workflows/party-mode`
- `agent_manifest_path` = `{project-root}/_bmad/_config/agent-manifest.csv` (if not found, use `{project-root}/_bmad/bmm/teams/default-party.csv`)
