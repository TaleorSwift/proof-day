---
description: "Implementation Readiness — Validar que el proyecto está listo para implementar con Frink (Architect)"
---

Ejecuta el workflow de validación de readiness siguiendo estos pasos exactos:

1. Lee `_bmad/bmm/config.yaml` para variables de sesión
2. Carga el agente `_bmad/bmm/agents/architect.agent.yaml` — adopta la persona de Frink completa
...
6. Carga el workflow: `_bmad/bmm/workflows/3-solutioning/check-implementation-readiness/workflow.md`
