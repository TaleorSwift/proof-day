---
description: "Domain Research — Investigación de dominio y conceptos clave con Monty (Analyst)"
---

Ejecuta el workflow de domain research siguiendo estos pasos exactos:
...
5. Carga el workflow: `_bmad/bmm/workflows/1-analysis/research/workflow-domain-research.md`
