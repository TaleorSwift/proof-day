---
description: "Edit PRD — Mejorar PRD existente con Lisa (PM)"
---

Ejecuta el workflow de edición de PRD siguiendo estos pasos exactos:
...
6. Carga el workflow: `_bmad/bmm/workflows/2-plan-workflows/create-prd/workflow-edit-prd.md`
