---
description: "Create Architecture — Arquitectura técnica con Frink (Architect)"
---

Ejecuta el workflow de creación de arquitectura siguiendo estos pasos exactos:
...
6. Carga el workflow: `_bmad/bmm/workflows/3-solutioning/create-architecture/workflow.md`
