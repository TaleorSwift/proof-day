---
description: "Sprint Planning — Planificación de sprint con Ned (SM)"
---

Ejecuta el workflow de sprint planning siguiendo estos pasos exactos:
...
5. Carga el workflow: `_bmad/bmm/workflows/4-implementation/sprint-planning/workflow.yaml`
