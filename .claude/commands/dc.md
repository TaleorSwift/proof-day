---
description: "Deploy Configure — Configurar infraestructura de despliegue con Wiggum (Deploy)"
---

Ejecuta el workflow de configuración de deploy siguiendo estos pasos exactos:
...
7. Carga el workflow: `_bmad/bmm/workflows/deploy/deploy-configure/workflow.yaml`
8. Sigue workflow.xml para ejecutar el workflow paso a paso
9. Espera confirmación del usuario ([C]) entre cada paso
