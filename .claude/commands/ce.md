---
description: "Create Epics & Stories — Descomponer PRD en épicas e historias con Lisa (PM)"
---

Ejecuta el workflow de creación de épicas siguiendo estos pasos exactos:
...
6. Carga el workflow: `_bmad/bmm/workflows/3-solutioning/create-epics-and-stories/workflow.md`
7. Sigue workflow.xml para ejecutar el workflow paso a paso
8. Espera confirmación del usuario ([C]) entre cada paso
9. Si story_tracking.enabled: sincroniza épicas y stories con Notion
