---
description: "Crear PRD — Workflow colaborativo completo con Lisa (PM)"
---

Ejecuta el workflow de creación de PRD siguiendo estos pasos exactos:
...
6. Carga el workflow: `_bmad/bmm/workflows/2-plan-workflows/create-prd/workflow-create-prd.md`
7. Sigue workflow.xml para ejecutar el workflow paso a paso
8. Espera confirmación del usuario ([C]) entre cada paso
9. Si story_tracking.enabled: sincroniza con Notion según protocolo
